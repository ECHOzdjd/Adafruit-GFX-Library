 ...
 public:
  ...
  void
    ...
    fillCircleHelper(int16_t x0, int16_t y0, int16_t r, uint8_t cornername,
	  ...
	  drawStar(int16_t x0, int16_t y0, int16_t outer_radius, int16_t inner_radius, uint8_t num_points, uint16_t color),
	  drawPolygon(int16_t x0, int16_t y0, int16_t radius, uint8_t num_sides, uint16_t color),
